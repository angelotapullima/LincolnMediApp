      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text('Acceder', style: TextStyle(fontSize: 20.0)),
  ...
  Widget _crearFondo(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        Positioned(top: -20.0, right: 320.0, child: circulo),
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              // Icon(Icons.image, color: Colors.white, size: 100.0),
